 ...
 * @author HP
 */
public class EliminarCuadratica extends javax.swing.JFrame {

    /**
     * Creates new form BusquedaLienal
     */
    public EliminarCuadratica() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarCuadratica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarCuadratica().setVisible(true);
            }
        });
    }
