 ...
 * @author HP
 */
public class InsercionCyNyPDoble extends javax.swing.JFrame {

    /**
     * Creates new form InsercionCyNyP
     */
    public InsercionCyNyPDoble() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("INGRESE PENSIÓN:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        boolean result = prin.miInstituto.InsertarDDireccion(cod,nom,pen);
        if(result == true){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InsercionCyNyPDoble.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InsercionCyNyPDoble().setVisible(true);
            }
        });
    }
