 ...
 * @author HP
 */
public class BusquedaDoble extends javax.swing.JFrame {

    /**
     * Creates new form BusquedaLienal
     */
    public BusquedaDoble() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int pos = prin.miInstituto.BuscarDDireccion(cod);
        if(pos != -1){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BusquedaDoble.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BusquedaDoble().setVisible(true);
            }
        });
    }
